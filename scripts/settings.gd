...
@export var sensitivity_default:int = 3
...
@onready var world_environment = get_node("/root/main/game/terrain/world_environment")
...
func _screen_space_reflections_updated(value: bool):
	world_environment.environment.ssr_enabled = value
