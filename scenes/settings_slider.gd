...
func _ready() -> void:
	...
	slider_text.text = Settings[slider_name+"_name"]
	slider_node.min_value = Settings[slider_name+"_min"]
	slider_node.max_value = Settings[slider_name+"_max"]
	slider_node.value = Settings[slider_name+"_default"]
	slider_node.step = Settings[slider_name+"_step"]
